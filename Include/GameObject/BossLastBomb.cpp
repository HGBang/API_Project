...
CBossLastBomb::CBossLastBomb() :
	m_Damage(0.f)
{
	SetTypeID<CBossLastBomb>();
}

CBossLastBomb::CBossLastBomb(const CBossLastBomb& Obj) :
	CGameObject(Obj),
	m_Angle(Obj.m_Angle),
...
bool CBossLastBomb::Init()
{


	//SetCurrentAnimationEndFunction<CBossLastBomb>(this, &CBossLastBomb::AnimationEnd);
	...
	Box->SetCollisionProfile("BossLastBomb");
	Box->SetExtent(30.f, 30.f);
	Box->SetCollisionBeginFunction<CBossLastBomb>(this, &CBossLastBomb::CollisionBegin);
	Box->SetCollisionEndFunction<CBossLastBomb>(this, &CBossLastBomb::CollisionEnd);
	...
	//Circle->SetCollisionBeginFunction<CBossLastBomb>(this, &CBossLastBomb::CollisionBegin);
	//Circle->SetCollisionEndFunction<CBossLastBomb>(this, &CBossLastBomb::CollisionEnd);

	return true;
}

void CBossLastBomb::Update(float DeltaTime)
{
...
void CBossLastBomb::PostUpdate(float DeltaTime)
{
	CGameObject::PostUpdate(DeltaTime);
}

void CBossLastBomb::Render(HDC hDC, float DeltaTime)
{
...
void CBossLastBomb::CollisionBegin(CCollider* Src, CCollider* Dest)
{
...
void CBossLastBomb::CollisionEnd(CCollider* Src, CCollider* Dest)
{
...
void CBossLastBomb::AnimationEnd()
{
