...
CBossCrossBomb::CBossCrossBomb() :
	m_Damage(0.f)
{
	SetTypeID<CBossCrossBomb>();
}

CBossCrossBomb::CBossCrossBomb(const CBossCrossBomb& Obj) :
	CGameObject(Obj),
	m_Angle(Obj.m_Angle),
...
bool CBossCrossBomb::Init()
{


	//SetCurrentAnimationEndFunction<CBossCrossBomb>(this, &CBossCrossBomb::AnimationEnd);
	...
	Box->SetCollisionProfile("BossCrossBomb");
	Box->SetExtent(30.f, 30.f);
	Box->SetCollisionBeginFunction<CBossCrossBomb>(this, &CBossCrossBomb::CollisionBegin);
	Box->SetCollisionEndFunction<CBossCrossBomb>(this, &CBossCrossBomb::CollisionEnd);
	...
	//Circle->SetCollisionBeginFunction<CBossCrossBomb>(this, &CBossCrossBomb::CollisionBegin);
	//Circle->SetCollisionEndFunction<CBossCrossBomb>(this, &CBossCrossBomb::CollisionEnd);

	return true;
}

void CBossCrossBomb::Update(float DeltaTime)
{
...
void CBossCrossBomb::PostUpdate(float DeltaTime)
{
	CGameObject::PostUpdate(DeltaTime);
}

void CBossCrossBomb::Render(HDC hDC, float DeltaTime)
{
...
void CBossCrossBomb::CollisionBegin(CCollider* Src, CCollider* Dest)
{
...
void CBossCrossBomb::CollisionEnd(CCollider* Src, CCollider* Dest)
{
...
void CBossCrossBomb::AnimationEnd()
{
