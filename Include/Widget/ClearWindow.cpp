...
bool CClearWindow::Init()
{
	...
	Back->SetTexture("1Round", TEXT("1Round.bmp"));
	Back->SetSize(1280.f, 720.f);

	/*CButton* StartButton = CreateWidget<CButton>("RoundStartButton");

	StartButton->SetTexture("RoundStartButton", TEXT("RoundStartButton.bmp"));
	...
	StartButton->SetCallback<CClearWindow>(EButton_Sound_State::Click, this, &CClearWindow::StartButtonCallback);*/
	...
	EditButton->SetCallback<CClearWindow>(EButton_Sound_State::Click, this, &CClearWindow::EditButtonCallback);*/
	...
	EndButton->SetCallback<CClearWindow>(EButton_Sound_State::Click, this, &CClearWindow::EndButtonCallback);*/
...
void CClearWindow::Update(float DeltaTime)
{
	...
	if (m_LoadingTime > 2.f)
	{
		...
		CSceneManager::GetInst()->CreateScene<CSecondScene>();
...
void CClearWindow::StartButtonCallback()
{
	CInput::GetInst()->ClearCallback();
	CSceneManager::GetInst()->CreateScene<CSecondScene>();
}

void CClearWindow::EditButtonCallback()
{
	CInput::GetInst()->ClearCallback();
	CSceneManager::GetInst()->CreateScene<CEditScene>();
}

void CClearWindow::EndButtonCallback()
{
