...
CGameClearWindow::CGameClearWindow()
{
}
...
bool CGameClearWindow::Init()
{
	...
	Back->SetTexture("Clear", TEXT("LastRound.bmp"));
	Back->SetSize(1280.f, 720.f);

	CButton* StartButton = CreateWidget<CButton>("BossStartButton");

	StartButton->SetTexture("ReStart", TEXT("FinalReStart.bmp"));
	...
	StartButton->SetPos(340.f, 550.f);
	StartButton->SetZOrder(1);

	StartButton->SetCallback<CGameClearWindow>(EButton_Sound_State::Click, this, &CGameClearWindow::StartButtonCallback);
	...
	//EditButton->SetCallback<CGameClearWindow>(EButton_Sound_State::Click, this, &CGameClearWindow::EditButtonCallback);


	CButton* EndButton = CreateWidget<CButton>("FianlEnd");

	EndButton->SetTexture("EndGameButton", TEXT("FinalEnd.bmp"));
	...
	EndButton->SetPos(740.f, 550.f);
	EndButton->SetZOrder(1);

	EndButton->SetCallback<CGameClearWindow>(EButton_Sound_State::Click, this, &CGameClearWindow::EndButtonCallback);
...
void CGameClearWindow::Update(float DeltaTime)
{
...
void CGameClearWindow::StartButtonCallback()
{
	CInput::GetInst()->ClearCallback();
	CSceneManager::GetInst()->CreateScene<CMainScene>();
}

void CGameClearWindow::EditButtonCallback()
{

}

void CGameClearWindow::EndButtonCallback()
{
